...
static void generate_tokens_test_onlyWhitespace(void **state)
{
        (void) state;
...
static void generate_tokens_test_singleToken(void **state)
{
        (void) state;
        ...
        size_t count1 = generate_tokens(buf1, MAX_TOKENS, tokens1);
        ...
        size_t count2 = generate_tokens(buf2, MAX_TOKENS, tokens2);
        ...
        size_t count3 = generate_tokens(buf3, MAX_TOKENS, tokens3);
        ...
        size_t count4 = generate_tokens(buf4, MAX_TOKENS, tokens4);
        ...
        size_t count5 = generate_tokens(buf5, MAX_TOKENS, tokens5);
        ...
        size_t count6 = generate_tokens(buf6, MAX_TOKENS, tokens6);
        ...
        size_t count7 = generate_tokens(buf7, MAX_TOKENS, tokens7);
...
static void generate_tokens_test_singleTokenBeforeNewline(void **state)
{
        (void) state;
...
static void generate_tokens_test_singleTokenTrailingWhitespace(void **state)
{
        (void) state;
...
static void generate_tokens_test_allTokenTypes(void **state)
{
        (void) state;
...
static void generate_tokens_test_mangledTokens(void **state)
{
        (void) state;
...
static void generate_tokens_test_tokensFull(void **state)
{
        (void) state;
...
static void generate_tokens_test_tokensExhausted(void **state)
{
        (void) state;
...
int main(void)
{
        const struct CMUnitTest tests[] = {
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_emptyBuffer, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_onlyWhitespace, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_singleToken, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_singleTokenBeforeNewline, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_singleTokenTrailingWhitespace, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_allTokenTypes, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_mangledTokens, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_tokensFull, NULL, NULL),
                cmocka_unit_test_setup_teardown(
                        generate_tokens_test_tokensExhausted, NULL, NULL),
        };
